import {
  Controller, Param, Post, Get, Body, Delete, HttpException, HttpStatus
} from '@nestjs/common';
...
export class UserController {
  ...
  async deleteUserAvatar(@Param('userId') userId: number) {
    ...
    console.log(deleted_avatar)
    if (!deleted_avatar) {
      throw new HttpException('Avatar counld not be found', HttpStatus.NOT_FOUND);
    }
